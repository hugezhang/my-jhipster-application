package com.foton.myjhipster.web.rest;
...
import com.foton.myjhipster.config.KafkaProperties;
...
class MyJhipsterKafkaResourceIT {
    ...
    void setup() {
        ...
        MyJhipsterKafkaResource kafkaResource = new MyJhipsterKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/my-jhipster-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/my-jhipster-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())

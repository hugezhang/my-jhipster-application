...
@RestController
@RequestMapping("/api/my-jhipster-kafka")
public class MyJhipsterKafkaResource {
    private final Logger log = LoggerFactory.getLogger(MyJhipsterKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public MyJhipsterKafkaResource(KafkaProperties kafkaProperties) {
